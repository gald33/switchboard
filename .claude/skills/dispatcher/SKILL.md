...
```bash
org tempo --repo /home/user/switchboard register --role dispatcher     # your agent id into coord/tempo/agents, so senders can wake you; answers `listener_alive` for step 6
...
field, then `org tempo --repo /home/user/switchboard dm --role ceo "blocked_written dispatcher"` —
